  ...
  return (
    <header className="container px-4 lg:px-6 h-14 flex items-center">
      <Link className="flex items-center justify-center" href="/">
        ...
        <span className="hidden lg:block ml-2 text-xl font-semibold text-gray-50 dark:text-gray-100">
          Nextbase Open Source
        </span>
        <span className="block lg:hidden ml-2 text-xl font-semibold text-gray-50 dark:text-gray-100">
          Nextbase
        </span>
      </Link>
